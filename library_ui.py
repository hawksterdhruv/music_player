...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.songs.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.songs.setShowGrid(False)
        self.songs.setGridStyle(QtCore.Qt.SolidLine)
        self.songs.setObjectName("songs")
        self.songs.horizontalHeader().setCascadingSectionResizes(False)
        self.songs.verticalHeader().setVisible(False)
